...
Hyperparameter choices are likely to impact regression-based game differently from categorization-based games. %, and therefore using the same hyperparameter configuration for both models is to be avoided.
...
This methodology is however computationally costly. %\footnote{
